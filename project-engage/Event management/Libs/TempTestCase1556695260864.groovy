...
RunConfiguration.setExecutionSettingFile('C:\\Users\\dche0053\\AppData\\Local\\Temp\\Katalon\\Test Cases\\testdn\\20190501_172051\\execution.properties')
...
//set Start date 
not_run: WebUI.setText(findTestObject('Page_Recently Viewed  Campaigns  Salesforce/Start_date'), '27/06/2019')
...
not_run: WebUI.setText(findTestObject('Page_Recently Viewed  Campaigns  Salesforce/End_Date (1)'), '30/06/2019')
...
not_run: def Guest = WebUI.getText(findTestObject('Page_Automated Guest List  Salesforce/a_Test Monash constituent'))
